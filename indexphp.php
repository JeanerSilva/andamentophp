...
<html lang="pt-br">
	...
	<body>
		...
		<main>
			...
			<input type="text" name="filtro" id="filtrar-tabela" placeholder="Informe o termo a ser filtrado (em qualquer campo)">
        	...
        	foreach ($Spreadsheet as $Key => $Row) {
          	if ($Row && ($Key > 3)) {
              	...
              	echo "<tr class =\"processos\">";
								echo "     <td class=\"processo1\">"; print_r($Row[1]);
              	echo "</td><td class=\"processo2\">"; print_r($Row[4]);
								echo "</td><td class=\"processo3\">"; print_r($Row[0]);
              	echo "</td><td class=\"processo4\">"; print_r($Row[2]);
              	echo "</td><td class=\"processo5\">"; print_r($Row[3]);
								echo "</td><td class=\"processo6\">"; print_r($Row[7]);
              	echo "</td><td class=\"processo7\">"; print_r($Andamentos);
              	echo "</td></tr>";
          	}
        	}
        	echo "</table>";
